...
public class MiGramaticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CONVOCA", "MAIN", "HECHIZO", "INT", "FLOAT", "DOUBLE", "CHAR", "BOOLEAN", 
			...
			"BOOLEAN_CONSTANTE", "ID", "INCREMENTO", "DECREMENTO", "IGUAL", "SUMA", 
			"RESTA", "MULTIPLICACION", "DIVISION", "IGUALDAD", "DIFERENCIA", "MAYOR_MENOR_IGUALQUE", 
