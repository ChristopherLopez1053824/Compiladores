...
public class GUICompilador extends JFrame {
    ...
    private void inicializarComponentes() {
        ...
        JLabel titulo =
                new JLabel("✨ Compilador Fantasía ✨");
        ...
        JButton btnCodigo =
                crearBotonSidebar("💻 Código");

        JButton btnTokens =
                crearBotonSidebar("📄 Tokens");

        JButton btnErrores =
                crearBotonSidebar("❌ Errores");

        JButton btnSimbolos =
                crearBotonSidebar("📚 Símbolos");

        JButton btnArbol =
                crearBotonSidebar("🌳 Árbol");
        ...
        RTextScrollPane scrollConsola =
                new RTextScrollPane(consola);
    ...
    private void analizarCodigo(ActionEvent e) {
        ...
        try {
            ...
            PrintWriter writer =
                    new PrintWriter("Programa.java");

            Traductor traductor =
                    new Traductor(writer);
    ...
    private void ejecutarPrograma(ActionEvent e) {
        ...
        try {
            ...
            StringBuilder erroresCompilacion =
                    new StringBuilder();

            while ((lineaCompilacion =
                    lectorCompilacion.readLine()) != null) {
